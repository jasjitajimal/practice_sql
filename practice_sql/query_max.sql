...
-- Following is the usage of MAX function.
-- Maximum age in the sample_table
SELECT MAX(age) AS max_age FROM sample_table;
/*
* Change Log:
*   2023-12-01 - Jasjit - Created query_max.sql.
*/