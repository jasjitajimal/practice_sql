...
-- Following is the usage of MIN function.
-- Minimum age in the sample_table
SELECT MIN(age) AS min_age FROM sample_table;
/*
* Change Log:
*   2023-12-01 - Jasjit - Created query_min.sql.
*/